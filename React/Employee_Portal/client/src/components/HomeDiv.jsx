...
const HomeDiv = () => {
  return (
    <Container sx={{ paddingTop: 4, paddingBottom: 4 }}>
      <Typography variant="h3" align="center" color='secondary' gutterBottom sx={{ fontWeight: 'bold', mb: 3,}}>
        Welcome to the Employee Portal
      </Typography>

      <Box sx={{ backgroundColor: '#f5f5f5', borderRadius: 2, padding: 4 }}>
        <Typography variant="body1" align="left" paragraph sx={{ lineHeight: 1.8, mb: 2 }}>
        ...
        <Typography variant="body1" align="left" paragraph sx={{ lineHeight: 1.8 }}>
